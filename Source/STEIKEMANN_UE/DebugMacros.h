...
#define PRINTPAR(X, ...) ( GEngine->AddOnScreenDebugMessage(-1, 0.f, FColor::Cyan, FString::Printf(TEXT(X), ##__VA_ARGS__)) )
#define PRINTPARLONG(X, ...) ( GEngine->AddOnScreenDebugMessage(-1, 1.f, FColor::Cyan, FString::Printf(TEXT(X), ##__VA_ARGS__)) )
